...
```toml
[dependencies]
alert-manager-api = { git = "https://github.com/rlgrpe/alert-manager-api.git", tag = "v0.1.3" }
```
...
```toml
[dependencies]
alert-manager-api = { git = "https://github.com/rlgrpe/alert-manager-api.git", tag = "v0.1.3", default-features = false, features = ["rustls-tls"] }
```
